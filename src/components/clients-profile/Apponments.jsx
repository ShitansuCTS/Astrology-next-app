...
const Appointment = () => {
    ...
    useEffect(() => {
        const fetchAppointments = async () => {
            try {
                const res = await fetch("/api/appointments?astrologerId=6927f9ab0be82854e08bb523", {
                    method: "GET",
                ...
                const calendarData = data.appointments.map((appt) => ({
                    id: appt._id,
...
const renderEventContent = (eventInfo) => {
    ...
    return (
        <div className={`event-fc-color flex fc-event-main ${colorClass} p-1 rounded-sm`}>
            ...
            <div className="fc-event-time">{eventInfo.event.start ? eventInfo.timeText : ""}</div>
